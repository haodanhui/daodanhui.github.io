 ...
 * @author dlee
 */
abstract public class BaseDruidConfig {
    ...
    public DruidDataSource druidDataSource() throws Exception {
        ...
        druidDataSource.setUsername(ConfigTools.decrypt(publicKey, getUsername()));
        druidDataSource.setPassword(ConfigTools.decrypt(publicKey, getPassword()));
